...
'TabIdUnique'             : 'Tab process have unique IDs',
'CookieSameDomain'        : 'Cookies may only be forwarded to the cookie process of the proper domain',
'CookieSameDomainEnables' : 'Cookie process can only receive a channel sent to a tab on same domain',
'CookieSameDomainImmAfter': 'Immediately after a cookie channel is created it is sent to a tab',
