...
(** val nat_rect : 'a1 -> (MlCoq.nat -> 'a1 -> 'a1) -> MlCoq.nat -> 'a1 **)

let rec nat_rect f f0 = function
| MlCoq.O -> f
| MlCoq.S n0 -> f0 n0 (nat_rect f f0 n0)

(** val nat_rec : 'a1 -> (MlCoq.nat -> 'a1 -> 'a1) -> MlCoq.nat -> 'a1 **)

let rec nat_rec f f0 = function
| MlCoq.O -> f
| MlCoq.S n0 -> f0 n0 (nat_rec f f0 n0)
...
(** val length : 'a1 list -> MlCoq.nat **)

let rec length = function
| [] -> MlCoq.O
| y::l' -> MlCoq.S (length l')
